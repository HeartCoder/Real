          ...
          <div className="max-w-4xl text-center">
            ...
            >
              <p className="text-sm md:text-base text-gray-200 mb-6 max-w-2xl mx-auto">
                Namaste North East Tours & Travels is one of the best travel agencies in Guwahati, providing Guwahati–Shillong cabs, airport transfers, and customized North East India tour packages. We cover Assam, Meghalaya, Arunachal Pradesh, and nearby destinations with professional drivers, clean vehicles, and affordable pricing.   
              </p>
            </motion.div>
